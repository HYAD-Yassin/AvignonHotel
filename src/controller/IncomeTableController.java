...
public class IncomeTableController {
    ...
    public TextField txtRoomCgh;
    public TextField txtMealCgh;
    public TextField txtServiceCgh;
    ...
    private void loadAllIncome() {
        ...
        for(Income i: DatabaseIncome.incomeTable){
            ...
            IncomeTM tm= new IncomeTM(i.getMonth(),i.getRoomCgh(), i.getServiceCgh(),button,i.getMonthAll(),i.getYearAll());
            obList.add(tm);
    ...
    public void monthlyIncomeOnAction(ActionEvent actionEvent) {
        double monthAvg=((tempRoom+tempService)/(12.00));
    ...
    public void annuallyIncomeOnAction(ActionEvent actionEvent) {
        double annual= tempRoom+tempService;
